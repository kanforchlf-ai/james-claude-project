...
| ---------- | -------------------------------------------------------------- | -------------------------- |
| 全會所     | `index.html`                                                   | 首頁總覽                   |
| 全會所     | `weekly.html` / `weekly-prev.html`                             | 本週點名 + 上週點名（左上角按鈕互切）|
...
| 設定項         | 值                                                                |
| -------------- | ----------------------------------------------------------------- |
| 8 區基數       | y1=24, y2=21, y3=23 / hs1=21, hs2=17, hs3=19 / ms1=52, ms2=46（2026-08 排區重組調整，合計 223；沿革見 update_dashboard.py 的 BASE_SIZE_ERAS）|
